...
# Filter for brain endothelial cells only
# Dataset has both astrocytes and endothelial cells
...
if(length(cell_type_cols) > 0) {
  ...
  if(sum(endothelial_samples) == 0) {
    ...
    cat("\nFiltered to", sum(endothelial_samples), "brain endothelial cell samples\n")
    cat("Focusing on BBB-forming cells\n")
  }
}
...
cat("\nFinal matched samples:", length(common_samples), "\n")
```
