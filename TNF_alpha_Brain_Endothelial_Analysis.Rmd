...
# Note: Working directory should be the project root
# If using RStudio, open the .Rproj file or use Session > Set Working Directory
```
...
if(dir.exists("data")) {
  ...
  stop("Data directory not found! Please ensure you are in the correct working directory.")
}
...
# Create treatment factor - find the stimulus column using pattern matching
...
if(length(factor_stimulus_cols) > 0) {
  # Prefer Factor.Value columns (standard Expression Atlas format)
  ...
  # Fall back to any column with "stimulus" in the name
